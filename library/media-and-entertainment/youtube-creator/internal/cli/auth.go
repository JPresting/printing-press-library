...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Youtube",
...
func newAuthLoginCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if clientID == "" {
				return fmt.Errorf("--client-id is required (get one at https://console.cloud.google.com/apis/credentials)")
			}
	...
	cmd.Flags().StringVar(&clientID, "client-id", os.Getenv("YOUTUBE_CLIENT_ID"), "OAuth2 client ID")
	cmd.Flags().StringVar(&clientSecret, "client-secret", os.Getenv("YOUTUBE_CLIENT_SECRET"), "OAuth2 client secret")
